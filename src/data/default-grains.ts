...
const allMalts: DefaultGrain[] = [
  ...
  { name: "Amber Dry Extract", lovibond: 12, gravity: 1.044, type: "Grain" },
  { name: "Amber Liquid Extract", lovibond: 12, gravity: 1.036, type: "Grain" },
  ...
  { name: "Caramel / Crystal 60L", lovibond: 60, gravity: 0, type: "Grain" },
  {
  ...
  {
    name: "Carapils (DeTRUEtrine Malt)",
    lovibond: 1,
    gravity: 0,
    type: "Grain",
  },
  ...
  { name: "Pale 2-Row", lovibond: 1, gravity: 0, type: "Grain" },
  ...
  { name: "Wheat Dry Extract", lovibond: 8, gravity: 1.044, type: "Grain" },
  { name: "Wheat Liquid Extract", lovibond: 8, gravity: 1.036, type: "Grain" },
  {
  ...
  { name: "White Wheat", lovibond: 2, gravity: 0, type: "Grain" },
